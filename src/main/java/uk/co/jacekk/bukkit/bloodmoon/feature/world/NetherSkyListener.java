...
public class NetherSkyListener extends BaseListener<BloodMoon> {
	...
	private void sendWorldEnvironment(Player player, Environment environment) {
		...
		// DimensionManager dimensionmanager, EnumDifficulty enumdifficulty, WorldType
		// worldtype, EnumGamemode enumgamemode
		PacketPlayOutRespawn packet = new PacketPlayOutRespawn(DimensionManager.a(environment.getId()),
				EnumDifficulty.getById(world.getDifficulty().getValue()), WorldType.NORMAL,
