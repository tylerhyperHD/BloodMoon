...
public class TexturePackListener extends BaseListener<BloodMoon> {
	 ...
	 * @param bloodmoon true to send BloodMoon texture pack, false to send normal
	 *                  texture pack
	 */
	public void sendResourcePack(World world, boolean bloodmoon) {
		PluginConfig worldConfig = plugin.getConfig(world);
		String resource = bloodmoon ? worldConfig.getString(Config.FEATURE_TEXTURE_PACK_BLOODMOON)
