...
public enum Feature {
	...
	SPAWN_CONTROL(MoreMobsListener.class, Config.FEATURE_SPAWN_CONTROL_ENABLED), // partially handled in
																					// ChunkProviderServer
	...
	/*
	 * private Feature(Class<? extends BaseListener<BloodMoon>> listenerClass,
	 * PluginConfigKey enabledConfigKey){ this.listenerClass = listenerClass;
	 * this.enabledConfigKey = enabledConfigKey; }
	 * 
	 * public Class<? extends BaseListener<BloodMoon>> getListenerClass(){ return
	 * this.listenerClass; }
	 */
