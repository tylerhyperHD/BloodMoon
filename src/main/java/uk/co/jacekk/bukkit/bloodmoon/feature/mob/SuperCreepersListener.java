...
public class SuperCreepersListener implements Listener {
	...
	public void onStart(BloodMoonStartEvent event) {
		...
		if (plugin.isFeatureEnabled(world, Feature.SUPER_CREEPERS)
				&& worldConfig.getBoolean(Config.FEATURE_SUPER_CREEPERS_LIGHTNING)) {
	...
	public void onCreatureSpawn(CreatureSpawnEvent event) {
		...
		if (entity.getType() == EntityType.CREEPER && plugin.isActive(world)
				&& plugin.isFeatureEnabled(world, Feature.SUPER_CREEPERS)
				&& worldConfig.getBoolean(Config.FEATURE_SUPER_CREEPERS_LIGHTNING)) {
			((Creeper) entity).setPowered(true);
		}
	}
