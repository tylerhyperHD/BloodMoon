...
public abstract class BloodMoonEntityLiving {
	...
	public static BloodMoonEntityLiving getBloodMoonEntity(EntityLiving nmsEntity) {
		try {
			return ReflectionUtils.getFieldValue(nmsEntity.getClass(), "bloodMoonEntity", BloodMoonEntityLiving.class,
					nmsEntity);
		} catch (Exception e) {
	...
	public void setFollowRangeMultiplier(double multiplier) {
		...
		AttributeModifier modifier = new AttributeModifier(followRangeUID, "BloodMoon follow range multiplier",
				multiplier, 1);
	...
	public void clearFollowRangeMultiplier() {
		AttributeInstance attributes = this.nmsEntity.getAttributeInstance(GenericAttributes.FOLLOW_RANGE);
		AttributeModifier modifier = new AttributeModifier(followRangeUID, "BloodMoon follow range multiplier", 1.0d,
				1);
	...
	public void setKnockbackResistanceMultiplier(double multiplier) {
		...
		// AttributeModifier modifier = new AttributeModifier(knockbackResistanceUID,
		// "BloodMoon knockback resistance multiplier", multiplier, 1);
	...
	public void clearKnockbackResistanceMultiplier() {
		AttributeInstance attributes = this.nmsEntity.getAttributeInstance(GenericAttributes.c);
		// AttributeModifier modifier = new AttributeModifier(knockbackResistanceUID,
		// "BloodMoon knockback resistance multiplier", , 1);
	...
	public void setSpeedMultiplier(double multiplier) {
		try {
			...
			if (BloodMoon.DEBUG) {
				System.err.println("Set speed attribute for mob " + this.nmsEntity.getName() + " was " + oldValue
						+ " and is now " + theAttribute.getValue());
			}
		...
		// this.nmsEntity.getAttributeInstance(GenericAttributes.d);
		// AttributeModifier modifier = new AttributeModifier(movementSpeedUID,
		// "BloodMoon movement speed multiplier", multiplier, 1);
		// attributes.c(modifier);
		// attributes.b(modifier);
	}
	...
	public void clearSpeedMultiplier() {
		...
		AttributeModifier modifier = new AttributeModifier(movementSpeedUID, "BloodMoon movement speed multiplier",
				1.0d, 1);
